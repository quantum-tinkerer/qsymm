...
class PointGroup(set):
    ...
    def __init__(self, generators, double_group=None, _tests=False):
...
class LittleGroup(SpaceGroup):
    def __init__(self, generators, k=None, double_group=None, allow_inconsistent=False, _tests=False):
    ...
    def covering_group(self):
        ...
        if all(g.phase is not None for g in self):
            self._covering_group = PointGroup(self)
        else:
